...
export namespace UsersQuery {
  ...
  export const getSelectedUserId = (state: ApplicationState) => state.users.selectedUserId;
  export const getSelectedUser = createSelector( getUsers, getSelectedUserId,
      (users, id) => {
